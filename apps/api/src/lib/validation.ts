...
export const DEFAULT_TIER_CONFIG = {
  tiers: [
    { name: "Core Maintainers", revenueShare: 40, splitMethod: "equal" as const },
    { name: "Active Contributors", revenueShare: 35, splitMethod: "equal" as const },
    { name: "Community", revenueShare: 15, splitMethod: "weighted" as const },
  ],
  treasuryShare: 10,
};
